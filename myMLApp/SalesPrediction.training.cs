...
namespace MyMLApp
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Kayro\Desktop\ML.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(@"Month", @"Month")      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=4,NumberOfLeaves=9,FeatureFraction=0.9696453F,LabelColumnName=@"Sales",FeatureColumnName=@"Features"}));
